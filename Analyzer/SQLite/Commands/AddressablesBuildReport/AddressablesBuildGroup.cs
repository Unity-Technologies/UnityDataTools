...
{
    /* TABLE DEFINITION:
        create table addressables_build_groups
        (
            id INTEGER,
            build_id INTEGER,
            guid TEXT,
    ...
    */
    ...
    {
        protected override string TableName => "addressables_build_groups";

        protected override string DDLSource => Properties.Resources.AddrBuildGroups;
