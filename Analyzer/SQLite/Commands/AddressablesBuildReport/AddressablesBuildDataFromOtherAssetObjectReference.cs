...
{
    /* TABLE DEFINITION:
        create table addressables_build_data_from_other_asset_object_references
        (
    ...
    */
    ...
    {
        protected override string TableName => "addressables_build_data_from_other_asset_object_references";
