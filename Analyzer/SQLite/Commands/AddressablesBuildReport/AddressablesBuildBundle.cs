...
{
    /* TABLE DEFINITION:
        create table addressables_build_bundles
        (
            id INTEGER,
            build_id INTEGER,
            asset_count INTEGER,
    ...
    */
    ...
    {
        protected override string TableName => "addressables_build_bundles";

        protected override string DDLSource => Properties.Resources.AddrBuildBundles;
