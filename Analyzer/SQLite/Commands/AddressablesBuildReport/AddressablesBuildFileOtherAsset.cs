...
{
    /* TABLE DEFINITION:
        create table addressables_build_file_other_assets
        (
            file_id INTEGER,
            build_id INTEGER,
    ...
    */
    ...
    {
        protected override string TableName => "addressables_build_file_other_assets";

        protected override string DDLSource => Properties.Resources.AddrBuildFileOtherAssets;
