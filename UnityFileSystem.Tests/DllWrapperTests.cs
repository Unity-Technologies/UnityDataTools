...
namespace UnityDataTools.FileSystem.Tests
{
    ...
    public class DllMountUnmountTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        public void MountArchive_ActualArchive_ReturnSuccess(
            [ValueSource(typeof(TestData), nameof(TestData.GetTestFolders))] string testFolder)
        {
    ...
    public class DllArchiveTests
    {
        private UnityArchiveHandle m_Archive;
        private string m_TestFolder;

        public DllArchiveTests(string testFolder)
        {
        ...
        public void GetArchiveNodeCount_ReturnExpectedCount()
        {
            ...
            Assert.AreEqual(ReturnCode.Success, r);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["NodeCount"], count);
        }
        ...
        public void GetArchiveNode_ValidArchive_ReturnExpectedNode()
        {
            ...
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-Size"], size);
            Assert.AreEqual(ArchiveNodeFlags.SerializedFile, (ArchiveNodeFlags)TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-Flags"]);
            ...
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994.resS-Size"], size);
            Assert.AreEqual(ArchiveNodeFlags.None, (ArchiveNodeFlags)TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994.resS-Flags"]);
            ...
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994.resource-Size"], size);
            Assert.AreEqual(ArchiveNodeFlags.None, (ArchiveNodeFlags)TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994.resource-Flags"]);
        }
    ...
    [TestFixtureSource(typeof(TestData), nameof(TestData.GetTestFolders))]
    public class DllLFileTests
    {
        private UnityArchiveHandle m_Archive;
        private string m_TestFolder;

        public DllLFileTests(string testFolder)
        {
            m_TestFolder = testFolder;
        }
    ...
    [TestFixtureSource(typeof(TestData), nameof(TestData.GetTestFolders))]
    public class DllSerializedFileTests
    {
        private UnityArchiveHandle m_Archive;
        private string m_TestFolder;

        public DllSerializedFileTests(string testFolder)
        {
            m_TestFolder = testFolder;
        }
        ...
        public void GetExternalReferenceCount_ValidSerializedFile_ReturnExpectedExternalReferenceCount()
        {
            ...
            Assert.AreEqual(ReturnCode.Success, r);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-ExtRefCount"], count);
        ...
        public void GetExternalReference_ValidSerializedFile_ReturnExpectedExternalReferences()
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                Assert.AreEqual(ReturnCode.Success, r);
                Assert.AreEqual(TestData.ExpectedValues[m_TestFolder][$"CAB-5d40f7cad7c871cf2ad2af19ac542994-ExtRef{i}-Guid"], guid.ToString());
                Assert.AreEqual(TestData.ExpectedValues[m_TestFolder][$"CAB-5d40f7cad7c871cf2ad2af19ac542994-ExtRef{i}-Path"], path.ToString());
                Assert.AreEqual((ExternalReferenceType)TestData.ExpectedValues[m_TestFolder][$"CAB-5d40f7cad7c871cf2ad2af19ac542994-ExtRef{i}-Type"], refType);
            }
        ...
        public void GetObjectCount_ValidSerializedFile_ReturnExpectedObjectCount()
        {
            ...
            Assert.AreEqual(ReturnCode.Success, r);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-ObjCount"], count);
        ...
        public void GetObjectInfo_ValidSerializedFile_ReturnExpectedObjectInfo()
        {
            ...
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-FirstObj-Id"], objectInfo[0].Id);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-FirstObj-Offset"], objectInfo[0].Offset);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-FirstObj-Size"], objectInfo[0].Size);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-FirstObj-TypeId"], objectInfo[0].TypeId);

            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-LastObj-Id"], objectInfo[count-1].Id);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-LastObj-Offset"], objectInfo[count-1].Offset);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-LastObj-Size"], objectInfo[count-1].Size);
            Assert.AreEqual(TestData.ExpectedValues[m_TestFolder]["CAB-5d40f7cad7c871cf2ad2af19ac542994-LastObj-TypeId"], objectInfo[count-1].TypeId);
    ...
    public class DllTypeTreeTests
    {
        ...
        public DllTypeTreeTests(string testFolder)
        {
            m_TestFolder = testFolder;
        }
