...
| Topic | Description |
|-------|-------------|
| [ContentLayout in the Analyze Database](contentlayout-database.md) | How the [`analyze` command](command-analyze.md) imports this file into queryable database tables. |
